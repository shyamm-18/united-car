...
allFiles.forEach(file => {
  ...
  newContent = newContent.replace(/concierge@luxedrive\.co/g, 'arebhai09@gmail.com');
  newContent = newContent.replace(/admin@luxedrive\.com/g, 'arebhai09@gmail.com');

  // Phone replacements
  newContent = newContent.replace(/\+1 \(555\) 000-8888/g, '9216497682');
  newContent = newContent.replace(/\+1 \(800\) LUXE-DRIV/g, '9216497682');
  ...
  newContent = newContent.replace(/100 Luxury Ave, Suite 500<br\/>\s*Beverly Hills, CA 90210/g, 'Jaipur, Rajasthan, 302020');
