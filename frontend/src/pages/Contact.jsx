            ...
            <div className="glass p-8 rounded-3xl relative overflow-hidden bg-white/60 dark:bg-slate-900/40">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="font-semibold text-lg">9784820100</p>
                </div>
              </div>
            </div>
            ...
            <div className="glass p-8 rounded-3xl relative overflow-hidden bg-white/60 dark:bg-slate-900/40">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="font-semibold text-lg hover:text-blue-600 transition-colors cursor-pointer">unitedcarsjhotwara@gmail.com</p>
                </div>
              </div>
            </div>
          ...
          >
            <div className="glass p-8 md:p-12 rounded-3xl bg-white/80 dark:bg-slate-900/60 shadow-xl border border-white/50 dark:border-slate-700/50">
              ...
              <form className="space-y-6">
                ...
                <div className="pt-2">
                  <button type="button" className="w-full md:w-auto flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-xl font-bold transition-all hover:shadow-[0_0_20px_rgba(37,99,235,0.4)]">
                    Send Inquiry
